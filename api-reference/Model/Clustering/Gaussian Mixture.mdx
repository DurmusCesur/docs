...
- **Overlapping zone classification**: When spatial zones (e.g., public/private spaces) do not have sharp boundaries and overlap naturally.
...
- **Heterogeneous clusters**: When clusters in your data have different shapes and densities (e.g., varying building footprint patterns).
