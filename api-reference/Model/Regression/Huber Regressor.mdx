...
<Note>
If your dataset contains **outliers** that you cannot or do not want to remove, Huber Regressor is an excellent choice. The **epsilon** parameter controls the threshold between small and large errors — the default value of `1.35` works well in most cases.
